...
class HomeCardWidget extends StatefulWidget {
  ...
  String title; 
  String subTitle; 
   HomeCardWidget({super.key,this.height = 100,this.width = 100,this.icons = Icons.abc,this.title = "",this.subTitle = ""});
...
class _HomeCardWidgetState extends State<HomeCardWidget> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      height: widget.height,width: widget.width,child: Column(
      mainAxisAlignment: MainAxisAlignment.spaceEvenly,
      children: [
        Icon(widget.icons,size: 40,),
        AppText(text: widget.title,fontSize: 20,fontWeight: FontWeight.bold,),
        AppText(text: widget.subTitle,fontSize: 18,fontWeight: FontWeight.w600,)
      ],
    ),);
  }
}
      ...
      child: Column(
        ...
        children: [
          const Padding(
            ...
            child: AppText(text: "Overview",fontSize: 20,fontWeight: FontWeight.bold,),
          ),
          const Spacer(),
          SizedBox(
            height: 200,
            ...
            BarChartData(
              barGroups: [
                ...
                BarChartGroupData(
                  x: 2,
                  barRods: [
                    BarChartRodData(toY: 5, color: Colors.red, width: 15),
                  ],
                ),
                BarChartGroupData(
                  x: 4,
                ...
                BarChartGroupData(
                  x: 7,
                  barRods: [
                    BarChartRodData(toY: 10, color: Colors.orange, width: 15),
                  ],
                ),
              ],
                ...
                bottomTitles: AxisTitles(
                  sideTitles: SideTitles(
                    ...
                    getTitlesWidget: (double value, TitleMeta meta) {
                      switch (value.toInt()) {
                        case 10:
                          return const Text('Ten');
                        case 2:
                          return const Text('Two');
                        case 4:
                          return const Text('Four');
                        case 7:
                          return const Text('Seven');
                        default:
                          return const Text('');
                      }
                    },
